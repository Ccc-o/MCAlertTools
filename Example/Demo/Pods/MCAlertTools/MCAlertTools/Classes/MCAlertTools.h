...
/** 按钮样式 */
typedef enum {
    MCAlertActionStyleDefault = 0,
    MCAlertActionStyleCancel,
    MCAlertActionStyleDestructive
}MCAlertActionStyle;


@interface MCAlertTools : NSObject
 ...
 *  @param destructiveBtnTitle    alertController的特殊按钮类型
